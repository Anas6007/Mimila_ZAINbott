<?php // @Ri_php & @Ri_php
ob_start();
$API_KEY = "7927707129:AAEqPYmdZAtkTfqr19l82H9ousRWLWU-Vw8";// توكن بوتك العزيز
$buy = "@CR7_YE";//  يوزرك تليكرام .
$sudo = "6877247991";// خلي ايديك هنا .
$admin = "$sudo";
$idBot = "7927707129";// ايدي بوتك خلي بشكل صحيح .
$admmm = $sudo;
$Dev = array("$sudo", "" );
$userrr = "Mimila_ZAINbot"; # خلي معرف بوتك بدون نيم ( @ )
...
$Dev = array("$admmm","6877247991"); # حط ايدي المطور ثاني المساعد او بكيفك خلي ايديك .
$channel = "sjadiraqi";
$token = API_KEY;
...
bot('sendmessage',['chat_id'=>$chat_id,'text'=>"⌔︙مرحبا انا بوت اسمي ميميلا 🎀💎
⌔︙[اضغط هنا الصنع بوت مجاني حمايه](t.me/CR7_YEE)
